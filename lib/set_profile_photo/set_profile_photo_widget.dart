...
class SetProfilePhotoWidget extends StatefulWidget {
  const SetProfilePhotoWidget({Key? key}) : super(key: key);

  @override
  _SetProfilePhotoWidgetState createState() => _SetProfilePhotoWidgetState();
}

class _SetProfilePhotoWidgetState extends State<SetProfilePhotoWidget> {

...
class _$ReviewsRecordSerializer implements StructuredSerializer<ReviewsRecord> {
  ...
  Iterable<Object?> serialize(Serializers serializers, ReviewsRecord object,
    ...
    value = object.numericalRating;
    if (value != null) {
      result
        ..add('numerical_rating')
        ..add(serializers.serialize(value,
      ...
      switch (key) {
        ...
        case 'user':
          result.user = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
        case 'numerical_rating':
          result.numericalRating = serializers.deserialize(value,
...
class _$ReviewsRecord extends ReviewsRecord {
  ...
  _$ReviewsRecord._(
      {this.writtenRating, this.user, this.numericalRating, this.ffRef})
      : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is ReviewsRecord &&
        ...
        user == other.user &&
        numericalRating == other.numericalRating &&
        ffRef == other.ffRef;
  }
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, writtenRating.hashCode), user.hashCode),
            numericalRating.hashCode),
        ffRef.hashCode));
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'ReviewsRecord')
          ...
          ..add('user', user)
          ..add('numericalRating', numericalRating)
          ..add('ffRef', ffRef))
        .toString();
  }
}
...
class ReviewsRecordBuilder
  ...
  double? _numericalRating;
  double? get numericalRating => _$this._numericalRating;
  set numericalRating(double? numericalRating) =>
      _$this._numericalRating = numericalRating;
  ...
  ReviewsRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _user = $v.user;
      _numericalRating = $v.numericalRating;
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
